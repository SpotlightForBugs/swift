// RUN: %target-swift-ide-test -print-module -cxx-interoperability-mode=swift-5.10 -print-implicit-attrs -module-to-print=VirtualMethods -I %S/Inputs -source-filename=x | %FileCheck %s
